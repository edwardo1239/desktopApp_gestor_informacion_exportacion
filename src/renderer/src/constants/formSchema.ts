...
export const control_plagas = {
    control: [
        ...
        { key: "areas_limpias_libres_de_residuos", label: "Áreas limpias, libres de residuos solidos, material vegetal y estancamiento de agua " },
        { key: "ausencia_animales_domesticos", label: "Ausencia de animales domésticos dentro de la planta" },
        { key: "rejillas_drenajes_sifones", label: "Rejillas, drenajes, sifones y vistieres " },
        ...
        { key: "sotano", label: "Estado sótano" }
    ],
    cebo: [
...
export const tipoFormularios = [
    { key: "limpieza_diari", label: "Limpieza diaría" },
